...
void callback(char* topic, byte* payload, unsigned int length) {
 ...
 if (strcmp((const char *)topic,"ledVERDE")==0)
 {
  if (payload[0]=='1') digitalWrite(LEDVERDE,HIGH);
  else digitalWrite(LEDVERDE,LOW);
 }
 if (strcmp(topic,"ledVERMELHO")==0)
 {
    if (payload[0]=='1') digitalWrite(LEDVERMELHO,HIGH);
